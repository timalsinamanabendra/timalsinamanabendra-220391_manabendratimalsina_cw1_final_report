...
<div class="other-links">
            ...
            <i class="fa-solid fa-user"></i>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: #0894d9;">
                      <li><span><?php echo $_SESSION['customer_name'] ?></span></li>
                      <li>Customer</a></li>
...
$sql = "SELECT product_id, name, payment_method, num, product_name FROM buy_detail";
...
while ($row = $result->fetch_assoc()) {
    echo '<tr class="table-row">
        ...
        <td><button><a class="delete-button" href="deleteproductdata.php?product_id=' . $row['product_id'] . '">Delete</a></button></td>
